...
const serve = express()
// 允许的域名数组
const allowedDomains = ['http://34.234.201.126:9001/', 'http://test.hpvideo.ai/', 'https://www.hpvideo.io/', 'https://hpvideo.io/', 'https://backend.hpvideo.io/'];
...
// 使用 router
serve.use('/api/getUser', checkRefererDomain, loginInfo)
