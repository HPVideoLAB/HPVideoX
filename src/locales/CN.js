export default {
  ...
  home: {
    cont1: {
      ...
      model9: {
        text: "特点与优势：以角色为中心的视频生成，支持同步音频。基于文本或图像输入生成短视频片段，动作自然、深度感强，适合头像动画、对话场景和风格化角色创作。",
        tips: "一个 5 秒动画风角色在阳光咖啡馆里的镜头，说出一句台词，带有匹配的口型和细腻表情。"
      },
      model10: {
        text: "特点与优势：高质量、运动多样化的视频生成，画面具备电影感与丰富细节，可处理多种主题、运镜与视觉风格，时间一致性强。",
        tips: "一个 8 秒的电影级镜头，横向推进古老图书馆，尘埃在空气中飘散，烛光映照着成排的皮革封面书籍和书桌前写作的学者。"
      }
    },
    cont2: {
      title: "我可以帮你做什么？",
    ...
    model: {
      ...
      li9: {
        title: "Luma Ray 2",
        text1: "发布日期：2025 年（Dream Machine 平台上 Ray 1 的继任者）；现已在 WaveSpeed 上线，目前尚无官方 “Ray 3” 时间表。",
        text2: "开发方：Luma AI（打造 Dream Machine 的美国研究实验室）。"
      }
    }
  },
  models: {
/* MODELS_HH_MARKER */
      modelHH: {
        ...
        text3_2: '👄 音素级口型同步，词错率 14.6% (业界领先)',
        text3_3: '🌏 7 种原生语言：英语、普通话、粤语、日语、韩语、德语、法语',
        text3_4: '🎬 电影感 720p / 1080p，5 秒片段约 38 秒生成',
        text4: '最适合叙事对白场景、谈话头内容、多语种广告、以及任何需要语音 + 口型却不想叠加额外流水线的视频。'
      },
    title: "HPVideo",
    ...
    model9: {
      ...
      text2: "开发方：Luma AI（打造 Dream Machine 的美国研究实验室）。",
      text3_1: "功能特性：",
      text3_2: "可根据文本与图像提示快速生成高真实感视频，运动幅度大、自然且连贯。",
      text3_3: "具备出色的物理真实感（流体动力学、物体交互）与电影级运镜，支持图生视频与关键帧控制。",
      text3_4: "针对流畅、可直接用于成片的运动进行了调校——适合电影级空镜、产品镜头与风格化片段。",
      text4: "输出：最高可达 1080p 的高清视频，时间一致性强，纹理细节丰富。"
    },
    model10: {
      title: "Vidu Q3",
      text1: "发布日期：2025 年 12 月（WaveSpeed 公开 API）；Vidu 1.5 的 Q 系列继任者，目前尚无官方 “Q4” 时间表。",
      text2: "开发方：生数科技（源自清华大学的中国 AI 实验室，Vidu 视频模型的开发者）。",
      text3_1: "功能特性：",
      text3_2: "可根据文本或图像提示生成 4 至 8 秒视频，出图快、对提示词的还原度高。",
      text3_3: "擅长流畅且符合物理规律的运动，并在整段镜头中保持角色一致性；除写实风格外，还具备鲜明的风格化/动漫表现力。",
      text3_4: "高性价比档位（4 秒 $0.40，8 秒 $0.80）——非常适合快速构思、分镜草稿与多镜头序列。",
      text4: "输出：最高可达 1080p 的高一致性视频，主体身份稳定，尤其适合角色驱动的短片与动画。"
    }
  },
  miners: {
  ...
  footer: {
    ...
    btn1: "试用 HPVideo",
    btn2: "观看演示",
    footer_bottom: "2026 HPVideo. 版权所有。"
  }
}