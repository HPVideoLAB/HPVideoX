export default {
  ...
  home: {
    cont1: {
      ...
      model9: {
        text: "特徴と利点：音声同期に対応したキャラクター中心の映像生成。テキストまたはテキスト+画像から自然な動きと奥行きのある短い映像を生成し、アバターアニメーション、対話シーン、スタイライズされたキャラクター作品に最適です。",
        tips: "陽光が差し込むカフェに座るアニメ風キャラクターが、口パクと繊細な表情と共に 1 行のセリフを話す 5 秒クリップ。"
      },
      model10: {
        text: "特徴と利点：動きのバリエーションが豊かで高品質な映像生成。映画的なルック、豊かなディテール、幅広い被写体とカメラワーク、強い時間的一貫性を実現します。",
        tips: "古い図書館をパンしていく 8 秒の映画風ショット。空気中を舞う塵、ろうそくの灯りが皮装丁の本の列と机で執筆する学者を照らす。"
      }
    },
    cont2: {
      title: "何を作りたいですか？",
    ...
    model: {
      ...
      li9: {
        title: "Luma Ray 2",
        text1: "リリース: 2025年（Dream Machine プラットフォーム上の Ray 1 の後継）。WaveSpeed で利用可能で、現時点で「Ray 3」の公式なタイムラインはありません。",
        text2: "開発元: Luma AI（Dream Machine を手がける米国拠点の研究ラボ）。",
      }
    }
  },
  models: {
/* MODELS_HH_MARKER */
      modelHH: {
        ...
        text3_2: '👄 音素レベルのリップシンク、WER 14.6% (業界最高水準)',
        text3_3: '🌏 7 ネイティブ言語: 英語、北京語、広東語、日本語、韓国語、ドイツ語、フランス語',
        text3_4: '🎬 シネマティック 720p / 1080p、5 秒クリップを約 38 秒で生成',
        text4: 'ナラティブな対話シーン、トーキングヘッド、多言語コマーシャル、音声+リップシンクが必要な動画に最適。追加のパイプラインは不要。'
      },
    title: "HPVideo",
    ...
    model9: {
      ...
      text2: "開発元：Luma AI（Dream Machine を手がける米国拠点の研究ラボ）。",
      text3_1: "機能概要：",
      text3_2: "テキストおよび画像プロンプトから、大きく自然で一貫した動きを持つ超リアルな映像を高速に生成します。",
      text3_3: "流体力学や物体同士の相互作用といった高い物理的リアリズムと映画的なカメラワークを備え、画像から映像への変換やキーフレーム制御に対応します。",
      text3_4: "滑らかで実制作に耐える動きに調整されており、映画的な B ロール、商品ショット、スタイライズされたシーンに適しています。",
      text4: "出力：高解像度映像（最大 1080p）、強い時間的一貫性と精細なテクスチャを実現。"
    },
    model10: {
      title: "Vidu Q3",
      text1: "リリース：2025年12月（WaveSpeed で一般 API 公開）。Vidu 1.5 に続く Q シリーズの後継で、現時点で「Q4」の公式なタイムラインはありません。",
      text2: "開発元：Shengshu Technology（清華大学からスピンアウトした中国拠点の AI ラボで、Vidu 動画モデルの開発元）。",
      text3_1: "機能概要：",
      text3_2: "テキストまたは画像プロンプトから 4〜8 秒の映像を、高速なターンアラウンドと高いプロンプト追従性で生成します。",
      text3_3: "滑らかで物理的に妥当な動きと、ショット全体で一貫したキャラクターの同一性を得意とし、フォトリアルな出力に加えてスタイライズ／アニメ調の表現にも対応します。",
      text3_4: "コスト効率に優れた料金帯（4秒 $0.40、8秒 $0.80）で、素早い発想出し、絵コンテの下書き、マルチショットのシーンに最適なデフォルトです。",
      text4: "出力：最大 1080p の高一貫性映像で被写体の同一性が安定しており、キャラクター主導のショート動画やアニメーションに適しています。"
    }
  },
  miners: {
