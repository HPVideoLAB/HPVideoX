...
export default defineComponent({
  ...
  setup() {
    ...
    const featuredPacks = [
      {
        ...
        featured: false,
        features: [
          'About 9 WAN 3.0 720p clips',
          'About 10 Kling O3 5s clips',
          'No expiry',
        ],
      },
      {
        ...
        featured: true,
        features: [
          '36 WAN 3.0 720p / 5s clips',
          '9 WAN 3.0 1080p / 10s clips',
          '3 Veo 3.1 8s clips',
          'No expiry',
        ],
      },
      {
        ...
        featured: false,
        features: [
          '90 WAN 3.0 720p / 5s clips',
          '9 Veo 3.1 8s clips',
          'Or 108 Kling O3 5s clips',
          'No expiry',
        ],
      },
    ];
    ...
    const costRows = [
      { id: 'ovi', name: 'OVI', note: 'Lifelike characters, fast', duration: '5s', resolution: 'std', price: 0.25, credits: 248 },
      { id: 'vidu', name: 'Vidu Q3', note: 'Fast, consistent characters', duration: '4s', resolution: 'std', price: 0.44, credits: 440 },
      { id: 'kling', name: 'Kling O3', note: 'Cinematic · great value', duration: '5s', resolution: 'std', price: 0.46, credits: 462, best: true },
      { id: 'wan-720', name: 'WAN 3.0', note: 'Photoreal · up to 30s', duration: '5s', resolution: '720p', price: 0.55, credits: 550 },
      { id: 'ltx', name: 'LTX 2.3', note: 'Fast social-media clips', duration: '6s', resolution: 'std', price: 0.59, credits: 594 },
      { id: 'pixverse', name: 'Pixverse V6', note: 'Stylised animation', duration: '5s', resolution: 'std', price: 0.66, credits: 660 },
      { id: 'hailuo', name: 'MiniMax H3', note: 'Strong motion', duration: '6s', resolution: '768p', price: 0.66, credits: 660 },
      { id: 'happyhorse', name: 'HappyHorse 1.1', note: '🥇 #1 · native audio + lip-sync', duration: '5s', resolution: '720p', price: 0.77, credits: 770 },
      { id: 'luma', name: 'Luma Ray 2', note: 'Cinematic motion', duration: '5s', resolution: 'std', price: 0.83, credits: 825 },
      { id: 'wan-1080', name: 'WAN 3.0', note: 'Photoreal, longer + sharper', duration: '10s', resolution: '1080p', price: 2.20, credits: 2200 },
      { id: 'seedance', name: 'Seedance 2.5', note: 'Cinematic, native audio', duration: '6s', resolution: '720p', price: 2.38, credits: 2376 },
      { id: 'veo', name: 'Veo 3.1', note: "Google's flagship, dialogue-aware", duration: '8s', resolution: 'std', price: 5.28, credits: 5280 },
    ];
